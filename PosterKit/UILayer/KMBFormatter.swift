...
//
//https://github.com/a-sarris/KMBFormatter/blob/main/Sources/KMBFormatter/KMBFormatter.swift
import Foundation
    ...
    enum Unit {
        ...
        var title: String {
            switch self {
                ...
                case .K:
                    return "thousandsKMBFormatter".localized
                    
                case .M:
                    return "millionsKMBFormatter".localized

                case .B:
                    return "billionsKMBFormatter".localized
            }
        }
    }
}
...
open class KMBFormatter: Formatter {
    ...
    open func string(fromNumber number: Int) -> String {
        string(fromNumber: Int64(number))
    }
